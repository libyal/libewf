     ...
     libcerror_error_t **error )
{
	...
	if( internal_handle->chunk_table != NULL )
	{
		libcerror_error_set(
		 ...
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		 LIBCERROR_RUNTIME_ERROR_VALUE_ALREADY_SET,
		 "%s: invalid handle - chunk table already set.",
		 function );
...
/* TODO refactor */
	if( libmfdata_list_initialize(
	     ...
	     (intptr_t *) internal_handle->chunk_table,
	     NULL,
	     NULL,
	     &libewf_chunk_table_read_chunk,
	     &libewf_chunk_table_read_offsets,
	     LIBMFDATA_FLAG_IO_HANDLE_NON_MANAGED,
	     error ) != 1 )
	{
		libcerror_error_set(
		 error,
...
/* TODO part of error tolerability changes
					internal_handle->chunk_table->previous_last_chunk_filled = 0;
					internal_handle->chunk_table->last_chunk_filled          = 0;
					internal_handle->chunk_table->last_chunk_compared        = 0;
*/
				}
#if defined( HAVE_VERBOSE_OUTPUT )
				known_section = 1;
	     ...
	     segment_files_list_index++ )
	{
		     ...
		     error ) != 1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
			 "%s: unable to retrieve segment file: %d from segment files list.",
			 function,
			 segment_files_list_index );
		...
		if( segment_file->segment_number != (uint32_t) ( segment_files_list_index + 1 ) )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_INPUT,
			 LIBCERROR_INPUT_ERROR_VALUE_MISMATCH,
			 "%s: segment number mismatch ( stored: %" PRIu32 ", expected: %d ).",
			 function,
			 segment_file->segment_number,
...
/* TODO get key info */
		     ...
		     error ) != 1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_APPEND_FAILED,
			 "%s: unable to set mapped range of element: %d in segment files list.",
			 function,
			 segment_files_list_index );

			return( -1 );
		}
		storage_media_offset += segment_file->storage_media_size;
	     ...
	     segment_files_list_index++ )
	{
		     ...
		     error ) != 1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
			 "%s: unable to retrieve segment file: %d from delta segment files list.",
			 function,
			 segment_files_list_index );
