 ...
 */
int libewf_buffer_data_handle_initialize(
     libewf_buffer_data_handle_t **data_handle,
     const uint8_t *data,
     size_t data_size,
     libcerror_error_t **error )
{
	static char *function = "libewf_buffer_data_handle_initialize";
	...
	*data_handle = memory_allocate_structure(
	...
	if( memory_set(
	     *data_handle,
	     0,
	     sizeof( libewf_buffer_data_handle_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
 ...
 * Returns 1 if successful or -1 on error
 */
int libewf_buffer_data_handle_free(
     libewf_buffer_data_handle_t **data_handle,
     libcerror_error_t **error )
{
	static char *function = "libewf_buffer_data_handle_free";
 ...
 */
ssize_t libewf_buffer_data_handle_read_segment_data(
         libewf_buffer_data_handle_t *data_handle,
         ...
         libcerror_error_t **error )
{
	static char *function = "libewf_buffer_data_handle_read_segment_data";
	size_t read_size      = 0;
 ...
 */
off64_t libewf_buffer_data_handle_seek_segment_offset(
         libewf_buffer_data_handle_t *data_handle,
         intptr_t *file_io_handle LIBEWF_ATTRIBUTE_UNUSED,
         int segment_index,
         int segment_file_index LIBEWF_ATTRIBUTE_UNUSED,
         ...
         libcerror_error_t **error )
{
	static char *function = "libewf_buffer_data_handle_seek_segment_offset";
