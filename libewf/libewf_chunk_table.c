     ...
     libcerror_error_t **error )
{
	     ...
	     error ) != 1 )
	{
		libcerror_error_set(
		 ...
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
		 "%s: unable to retrieve checksum error: %" PRIu32 " from checksum errors range list.",
		 function,
		 error_index );
	...
	if( result != 0 )
	{
		...
		if( result == -1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
			 "%s: unable to retrieve chunk group from segment file: %d at offset: %" PRIi64 ".",
			 function,
			 *segment_files_list_index,
			 *segment_file_data_offset );
	...
	if( result != 0 )
	{
		...
		if( result == -1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
			 "%s: unable to retrieve chunk: %" PRIu64 " from chunk group: %d in segment file: %d at offset: %" PRIi64 ".",
			 function,
			 chunk_index,
			 chunk_groups_list_index,
			 segment_files_list_index,
	...
	if( result != 0 )
	{
		...
		if( result == -1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
			 "%s: unable to retrieve chunk: %" PRIu64 " data from chunk group: %d in segment file: %d at offset: %" PRIi64 ".",
			 function,
			 chunk_index,
			 chunk_groups_list_index,
			 segment_files_list_index,
	...
	if( result != 0 )
	{
		...
		if( result == -1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_SET_FAILED,
			 "%s: unable to set chunk: %" PRIu64 " data in chunk group: %d in segment file: %d at offset: %" PRIi64 ".",
			 function,
			 chunk_index,
			 chunk_groups_list_index,
			 segment_files_list_index,
