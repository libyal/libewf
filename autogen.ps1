...
Get-Content -Path include\${Library}.h.in | % { $_ -Replace "@HAVE_V1_API@","0" } > include\${Library}.h
Get-Content -Path include\${Library}\definitions.h.in | % { $_ -Replace "@VERSION@",${Version} } | % { $_ -Replace "@HAVE_V1_API@","0" } > include\${Library}\definitions.h
