...
enum LIBEWF_INPUT_ERROR
{
	...
	LIBEWF_INPUT_ERROR_CRC_MISMATCH            = 5
};
...
enum LIBEWF_RUNTIME_ERROR
{
	...
	LIBEWF_RUNTIME_ERROR_INITIALIZE_FAILED     = 2,
	LIBEWF_RUNTIME_ERROR_RESIZE_FAILED         = 3,
	LIBEWF_RUNTIME_ERROR_FREE_FAILED           = 4,
	LIBEWF_RUNTIME_ERROR_GET_FAILED            = 5,
	LIBEWF_RUNTIME_ERROR_SET_FAILED            = 6,
	LIBEWF_RUNTIME_ERROR_APPEND_FAILED         = 7,
	LIBEWF_RUNTIME_ERROR_REMOVE_FAILED         = 8,
	LIBEWF_RUNTIME_ERROR_VALUE_OUT_OF_RANGE    = 9
};
