...
#endif
{
	...
	if( ewfcommon_abort == 0 )
	{
		     ...
		     &alter_offset ) == -1 )
		{
			...
			fprintf( stderr, "Unable to determine the altertion offset defaulting to: %" PRIu64 ".\n",
			 alter_offset );
		}
		if( ewfinput_get_size_variable(
		     stdout,
		     ...
		     &alter_size ) == -1 )
		{
			...
			fprintf( stderr, "Unable to determine the altertion size defaulting to: %" PRIu64 ".\n",
			 alter_size );
		}
		if( ewfinput_get_size_variable(
		     stdout,
		     ...
		     &alter_buffer_size ) == -1 )
		{
			...
			fprintf( stderr, "Unable to determine the altertion buffer size defaulting to: %" PRIu64 ".\n",
			 alter_size );
		}
