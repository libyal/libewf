...
typedef struct ewftools_option ewftools_option_t;

struct ewftools_option
{
...
void ewftools_getopt_wrapped_fprint(
      FILE *stream,
...
void ewftools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const ewftools_option_t *options,
      int number_of_options );

int ewftools_getopt_get_options_string(
     const ewftools_option_t *options,
     int number_of_options,
