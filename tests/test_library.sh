...
LIBRARY_TESTS="access_control_entry analytical_data attribute case_data chunk_data chunk_group chunk_table data_chunk deflate device_information digest_section error error2_section file_entry hash_sections hash_values header_sections header_values io_handle lef_extended_attribute lef_file_entry lef_permission lef_source lef_subject ltree_section md5_hash_section media_values notify permission_group read_io_handle restart_data section_descriptor sector_range segment_file segment_table serialized_string session_section sha1_hash_section single_files source volume_section write_io_handle";
