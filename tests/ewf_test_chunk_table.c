...
#endif
{
	...
	/* TODO: add tests for libewf_chunk_table_initialize */

	EWF_TEST_RUN(
	 "libewf_chunk_table_free",
	 ewf_test_chunk_table_free );

	/* TODO: add tests for libewf_chunk_table_clone */

	/* TODO: add tests for libewf_chunk_table_get_number_of_checksum_errors */
