...
#include "../ewftools/path_string.h"

/* Tests the path_string_copy_hexadecimal_to_integer_32_bit function
 * Returns 1 if successful or 0 if not
 */
int ewf_test_tools_path_string_copy_hexadecimal_to_integer_32_bit(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int ewf_test_tools_path_string_copy_from_file_entry_path(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int ewf_test_tools_path_string_copy_to_file_entry_path(
     void )
{
...
#endif
{
	...
	EWF_TEST_RUN(
	 ...
	 ewf_test_tools_path_string_copy_hexadecimal_to_integer_32_bit )

	EWF_TEST_RUN(
	 "path_string_copy_from_file_entry_path",
	 ewf_test_tools_path_string_copy_from_file_entry_path )

	EWF_TEST_RUN(
	 "path_string_copy_to_file_entry_path",
	 ewf_test_tools_path_string_copy_to_file_entry_path )
