...
#if !defined( _EWF_TEST_EXTERN_H )
#define _EWF_TEST_EXTERN_H

#include <common.h>

#if !defined( __CYGWIN__ ) && !defined( _WIN32 ) && defined( __has_attribute )
#if __has_attribute( visibility )
#define EWF_TEST_INTERNAL	__attribute__((visibility("hidden"))) extern

#else
#define EWF_TEST_INTERNAL	extern
...
#endif /* !defined( _EWF_TEST_EXTERN_H ) */
